...
public class CommentController {
    ...
    public String addComment(@PathVariable String advertId, @RequestBody CommentDto commentDto){
    ...
    public String updateComment(@PathVariable String advertId, @RequestBody CommentDto commentDto) throws EntityNotFoundException {
